...
//   style={{ width: '824px'}}
// >
//   <ReviewFormTwo onSubmit={(formData) => console.log("Form Submitted", formData)} />
// </div>
...
//                   <button className="overflow-hidden text-stone-50 px-4 py-3 my-auto text-xl font-semibold bg-amber-500 rounded-lg">
//                     + Yeni Rəy
//                   </button>
//                 </div>
//               </div>
...
//                           return (
//                             <p
//                               className="text-sm text-[#575757] font-normal  leading-5 tracking-wide text-left"
//                               key={index}
//                             >
//                               {formattedDate}
//                             </p>
...
//                         })}
//                         <div className="w-[5px] h-[5px] bg-[#D9D9D9] rounded-full mx-[18px] "></div>
//                         <p className="text-sm text-[#575757] font-normal leading-5 tracking-wide text-left">
//                           {doctor.reviews.map(r => r.fullName)}
//                         </p>
//                       </div>
//                     </div>
//                   ))}
...
export default function DoctorProfile({
  ...
  return (
    <>
      ...
      {/* Sliding Review Form */}
      <div
        className={`fixed top-0 right-0 overflow-scroll h-[500px] hidden-scrollbar bg-white shadow-lg z-50 transform transition-transform duration-300 ${
          isReviewFormOpen ? 'translate-x-0' : 'translate-x-full'
        }`}
        style={{ width: '824px', height: '100vh' }}
      >
        <ReviewFormTwo onSubmit={(formData) => console.log("Form Submitted", formData)} />
      </div>
