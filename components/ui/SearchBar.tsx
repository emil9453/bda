...
//     ] 
//   },
//   { value: "Surgical", label: "Surgical", subcategories: [
//       { value: "Neurologist", label: "Neurologist" },
//       { value: "Orthopedic Surgeon", label: "Orthopedic Surgeon" }
//     ]
//   },
//   { value: "Diagnostic", label: "Diagnostic", subcategories: [
...
//           <ul className="absolute top-[595px] bg-white border border-gray-300 mt-1 w-[200px] z-10 max-h-60 overflow-y-auto">
